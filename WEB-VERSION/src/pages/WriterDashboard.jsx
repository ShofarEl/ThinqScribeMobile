      ...
      <Content className="dashboard-content">
        <div className="dashboard-container">
          ...
          <Card 
            title={
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  <ProjectOutlined className="mr-2" style={{ fontSize: '20px', color: '#1890ff' }} />
                  <span style={{ fontSize: '20px', fontWeight: 600 }}>Project Management</span>
                </div>
            ...
            className="projects-card projects-section premium-card"
            style={{ borderRadius: '16px' }}
            bodyStyle={{ padding: '0' }}
          >
            <div style={{ padding: '16px 24px 0 24px', marginBottom: '16px' }}>
              <Text type="secondary" style={{ fontSize: '14px' }}>
