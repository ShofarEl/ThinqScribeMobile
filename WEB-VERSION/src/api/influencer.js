...
export const influencerApi = {
  ...
  getInfluencers: async () => {
    try {
      ...
      console.log('✅ [Influencer API] Influencers received:', response);
      return response;
    } catch (error) {
  ...
  getInfluencerDashboard: async (id) => {
    try {
      ...
      console.log('✅ [Influencer API] Dashboard received:', response);
      return response;
    } catch (error) {
  ...
  getInfluencerAnalytics: async () => {
    try {
      ...
      console.log('✅ [Influencer API] Analytics received:', response);
      return response;
    } catch (error) {
