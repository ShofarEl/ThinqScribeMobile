            ...
            <Col xs={24} lg={14}>
              ...
              <Card 
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      <BookOutlined style={{ color: '#1e3a8a', fontSize: '18px' }} />
                      <span style={{ fontSize: '18px', fontWeight: '600' }}>Project Information</span>
                    </div>
                  }
              ...
              <Card 
                title={
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <span style={{ fontSize: '18px', fontWeight: '600' }}>Project Progress</span>
                  </div>
                }
                ...
                <Card 
                  title={
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      ...
                      <span style={{ fontSize: '18px', fontWeight: '600' }}>Payment Schedule</span>
                    </div>
                  }
                ...
                <Card 
                  title={
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      ...
                      <span style={{ fontSize: '18px', fontWeight: '600' }}>Payment Information</span>
                    </div>
                  }
                  style={{ ...modernStyles.paymentCard, marginBottom: '24px' }}
                >
                  <div style={{ textAlign: 'center', padding: '24px' }}>
                    ...
                    <div style={{ marginBottom: '12px' }}>
                      <Text style={{ fontSize: '22px', fontWeight: 'bold', color: '#52c41a' }}>
              ...
              <Card 
                title={
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <span style={{ fontSize: '18px', fontWeight: '600' }}>Summary</span>
                  </div>
                }
                style={modernStyles.modernCard}
              >
